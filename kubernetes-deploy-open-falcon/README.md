...
This project fork from https://github.com/open-falcon/falcon-plus.
...
attation：
1，mysql user access grant must be set  
2，error message：“HTTPConnectionPool(host='open-falcon', port=8080): Max retries exceeded with url: /api/v1/user/login (Caused by : [Errno 111] Connection refused)  
solution：in all yaml file about “PORTAL_DB_PASS” value must be same；  
open-falcon-plus pod must be check service is all good.
